...
class InfolinkClient
 ...
 searchPatternAndCreateLinks : (inputFiles, tag, opts) ->
  opts.execution =
   ...
   inputFiles: inputFiles
   infolisPatternTags: [tag]
   queryServiceClasses: ['io.github.infolis.infolink.querying.DaraHTMLQueryService']
   searchResultLinkerClass: ['io.github.infolis.algorithm.BestMatchLinker']
  return @execute opts
    
 identifySourcesAndClaims: (inputFiles, opts) ->
  opts.execution or= {}
  opts.execution.algorithm = 'io.github.infolis.algorithm.ReportedSpeechTagger'
  opts.execution.inputFiles = inputFiles
  return @execute opts

 #searchPatternAndCreateLinks: (inputFiles, tag, opts) ->
 #    opts.execution or= {}
 #    opts.execution.algorithm = 'io.github.infolis.algorithm.SearchPatternsAndCreateLinks'
 #    opts.execution.inputFiles = inputFiles
 #    opts.execution.infolisPatternTags = [tag]
 #    opts.execution.queryServiceClasses = ['io.github.infolis.infolink.querying.DaraSolrQueryService']
